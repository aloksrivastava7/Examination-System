					...
					<form class="login100-form validate-form">
						...
						<div class="container-login100-form-btn">
							<div class="wrap-login100-form-btn">
								...
								<button class="login100-form-btn" type="submit" formaction="zStable.jsp" value="Add/Update Student" >
									Add/Update Student
								</button>
							</div>
						</div>
						...
						<div class="container-login100-form-btn">
							<div class="wrap-login100-form-btn">
								<div class="login100-form-bgbtn"></div>
								<button class="login100-form-btn" type="submit" formaction="zItable.jsp" value="Add/Update Instruction" >
						...
						<div class="container-login100-form-btn">
							<div class="wrap-login100-form-btn">
								<div class="login100-form-bgbtn"></div>
								<button class="login100-form-btn"type="submit" formaction="zQtable.jsp" value="Add/Update Question" >
									Add/Update Question
								</button>
							</div>
						</div>
