...
<%@ page import= "java.sql.*"%>
			...
			<div class="wrap-table100">
				<div class="table100">
					<table>
						...
						<%
			while(rs.next())
			{ if(s.equals(rs.getString("instruction"))){
				%><tbody>
							<tr>
					...
					<td><form>
			 			<input type="text" value="<%=s%>" name="instruction">
						
					</td>
					<td><h5><input style="color:green; " type="submit" value="Modify " formaction="zIupdate2.jsp"> </h5><br><a href="zIdelete.jsp?id=<%=rs.getString("instruction")%>" > - Delete</a></td>
				</tr>
	...
	<%
			...
			<hr>
			<center><input type="button" name="Exit" style="white-space: normal;" value="Add Instruction" class="btn" onclick="window.location.href='AddInstr.html';"><br><br>
